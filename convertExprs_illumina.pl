...
my $file_dir           = '/home/zhenyisong/data/wanglilab/GSE56860';
chdir($file_dir);
my $annotion_file_name = 'GPL6887-10677.txt';
my $matrix_file_name   = 'GSE56860_series_matrix.txt';
