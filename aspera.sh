...
# create cro
# crontab -e
# 0 0-23/2 * * * /home/zhenyisong/data/wanglilab/wangcode/aspera.sh
# crontab -l
# @version
#   1.001
# @since 
...
NCBI_DIR='/sra/sra-instant/reads/ByStudy/sra/SRP/SRP056/SRP056382/'
OUTPUT_DIR='/home/zhenyisong/data/cardiodata'


# to shorten the command line code.
ASCP='/home/zhenyisong/.aspera/connect/bin/ascp'
PASS_WORD='/home/zhenyisong/.aspera/connect/etc/asperaweb_id_dsa.openssh'
